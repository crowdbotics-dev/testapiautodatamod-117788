...
## Project Structure
    ...
    ├── testapiautodatamod_117788  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_117788`
...
2. Clone this repo and `cd testapiautodatamod_117788`
